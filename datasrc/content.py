...
anim = Animation("inair_up_left")
anim.back_foot.frames.Add(AnimKeyframe(0, 14, 0, -0.26))
anim.front_foot.frames.Add(AnimKeyframe(0, 10, 0, -0.26))
container.animations.Add(anim)

anim = Animation("inair_up_right")
anim.back_foot.frames.Add(AnimKeyframe(0, -14, 0, 0.26))
anim.front_foot.frames.Add(AnimKeyframe(0, -10, 0, 0.26))
container.animations.Add(anim)

anim = Animation("inair_down")
...
anim = Animation("walk_slope_left")
anim.body.frames.Add(AnimKeyframe(0.0, 0, 0, 0))
anim.body.frames.Add(AnimKeyframe(0.2, 0,-1, 0))
anim.body.frames.Add(AnimKeyframe(0.4, 0, 0, 0))
anim.body.frames.Add(AnimKeyframe(0.6, 0, 0, 0))
...
anim.back_foot.frames.Add(AnimKeyframe(0.0, 8+12, 0, 0-0.125))
anim.back_foot.frames.Add(AnimKeyframe(0.2, -8+12, 0, 0-0.125))
anim.back_foot.frames.Add(AnimKeyframe(0.4,-10+12,-4, 0.2-0.125))
anim.back_foot.frames.Add(AnimKeyframe(0.6, -8+12,-8, 0.3-0.125))
anim.back_foot.frames.Add(AnimKeyframe(0.8, 4+12,-4,-0.2-0.125))
anim.back_foot.frames.Add(AnimKeyframe(1.0, 8+12, 0, 0-0.125))

anim.front_foot.frames.Add(AnimKeyframe(0.0,-10,-4, 0.2-0.125))
anim.front_foot.frames.Add(AnimKeyframe(0.2, -8,-8, 0.3-0.125))
anim.front_foot.frames.Add(AnimKeyframe(0.4, 4,-4,-0.2-0.125))
anim.front_foot.frames.Add(AnimKeyframe(0.6, 8, 0, 0-0.125))
anim.front_foot.frames.Add(AnimKeyframe(0.8, 8, 0, 0-0.125))
anim.front_foot.frames.Add(AnimKeyframe(1.0,-10,-4, 0.2-0.125))
container.animations.Add(anim)

anim = Animation("walk_slope_right")
anim.body.frames.Add(AnimKeyframe(0.0, 0, 0, 0))
anim.body.frames.Add(AnimKeyframe(0.2, 0,-1, 0))
anim.body.frames.Add(AnimKeyframe(0.4, 0, 0, 0))
anim.body.frames.Add(AnimKeyframe(0.6, 0, 0, 0))
...
anim.back_foot.frames.Add(AnimKeyframe(0.0, 8, 0, 0+0.125))
anim.back_foot.frames.Add(AnimKeyframe(0.2, -8, 0, 0+0.125))
anim.back_foot.frames.Add(AnimKeyframe(0.4,-10,-4, 0.2+0.125))
anim.back_foot.frames.Add(AnimKeyframe(0.6, -8,-8, 0.3+0.125))
anim.back_foot.frames.Add(AnimKeyframe(0.8, 4,-4,-0.2+0.125))
anim.back_foot.frames.Add(AnimKeyframe(1.0, 8, 0, 0+0.125))

anim.front_foot.frames.Add(AnimKeyframe(0.0,-10-12,-4, 0.2+0.125))
anim.front_foot.frames.Add(AnimKeyframe(0.2, -8-12,-8, 0.3+0.125))
anim.front_foot.frames.Add(AnimKeyframe(0.4, 4-12,-4,-0.2+0.125))
anim.front_foot.frames.Add(AnimKeyframe(0.6, 8-12, 0, 0+0.125))
anim.front_foot.frames.Add(AnimKeyframe(0.8, 8-12, 0, 0+0.125))
anim.front_foot.frames.Add(AnimKeyframe(1.0,-10-12,-4, 0.2+0.125))
container.animations.Add(anim)

anim = Animation("slide_ground_left")
anim.back_foot.frames.Add(AnimKeyframe(0, -12, 0, 0))
anim.front_foot.frames.Add(AnimKeyframe(0, 14,-6, -0.3))
container.animations.Add(anim)
anim = Animation("slide_ground_right")
anim.back_foot.frames.Add(AnimKeyframe(0, -14, -6, 0.3))
anim.front_foot.frames.Add(AnimKeyframe(0, 10,0, 0))
container.animations.Add(anim)

anim = Animation("slide_slope_left")
anim.back_foot.frames.Add(AnimKeyframe(0, -10, 0, 0.15))
anim.front_foot.frames.Add(AnimKeyframe(0, -6, 0, 0.15))
container.animations.Add(anim)
anim = Animation("slide_slope_right")
anim.back_foot.frames.Add(AnimKeyframe(0, 10, 0, -0.15))
anim.front_foot.frames.Add(AnimKeyframe(0, 6, 0, -0.15))
container.animations.Add(anim)

anim = Animation("idle_slope_left")
anim.back_foot.frames.Add(AnimKeyframe(0, -7+12, 4, 0-0.125))
anim.front_foot.frames.Add(AnimKeyframe(0, 12, -4, 0-0.125))
container.animations.Add(anim)
anim = Animation("idle_slope_right")
anim.back_foot.frames.Add(AnimKeyframe(0, -12, -4, 0+0.125))
anim.front_foot.frames.Add(AnimKeyframe(0, 7-12, 4, 0+0.125))
container.animations.Add(anim)

...
int CCollision::SolidState(int x, int y, bool* nohook) const
{
...
int CCollision::TestBox(vec2 Pos, vec2 Size) const
{
	Size *= 0.5f;
	int r;
...
void CCollision::MoveBox(vec2 *pInoutPos, vec2 *pInoutVel, vec2 Size, float Elasticity, bool check_speed) const
{
	// do the move
	vec2 Pos = *pInoutPos;
	vec2 Vel = *pInoutVel;
